;(function(undefined) {
    ...
    RotateVerify.prototype = {
        ...
        initCanvasImg:function () {
			 $.post(this.settings.initUrl, {
				 dragWrap: this.$slideDragWrap.width(),
				 dragBtn: this.$slideDragBtn.width()
			 }, (res) => {
				 if (res.code === 0) {
					 this.randRot = res.data.randRot;
					 this.disLf = 0;
					 this.initImgSrc();
				 }
			 }, 'json');
        ...
        initMouse:function () {
            ...
            $(document).off('mouseup').on('mouseup',function() {
				...
				$.post(_this.settings.verifyUrl, _this.settings.verifyParam, function (res) {
					if (res.code === 0) {
